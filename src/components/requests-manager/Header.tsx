...
export const Header = () => {
  return (
    <header class="flex flex-col justify-between px-4 py-5 sm:px-6 md:flex-row lg:bg-gray-50">
      <h2 class="flex flex-row text-lg leading-6 font-medium text-gray-900">
        <svg
          aria-hidden="true"
          class="mt-2 mr-3 -mb-1 h-7 w-7 flex-shrink-0 text-gray-900 opacity-40 md:mt-0"
        ...
        <span>{i18n.t("requestsManager.title")}</span>
      </h2>
      <time class="flex items-center">
        <span class="-mt-2 ml-10 text-sm text-gray-600 md:mt-0 md:ml-0">Refreshed May 1, 2024 at 3:30pm EST</span>
      </time>
    </header>
  );
};
